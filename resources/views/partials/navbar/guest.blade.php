        ...
        <div class="relative ml-3" x-data="{ open: false }">
            <div>
                <button @click="open = !open" type="button"
                    ...
                    <img class="h-8 w-8 rounded-full" src="{{ asset('assets/img/login-circle-svgrepo-com.svg') }}"
                        alt="Log In" />
                </button>
            </div>
            ...
            <div x-show="open" @click.away="open = false"
                ...
                <a href="./login" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                    role="menuitem" tabindex="-1" id="user-menu-item-0">Sign/Log In</a>
                <a href="./register" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                    role="menuitem" tabindex="-1" id="user-menu-item-1">Register/Sign Up</a>
            </div>
        </div>
    </div>
